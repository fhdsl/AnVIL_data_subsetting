...
You need to specify the relevant columns of the "DATA" as inputs to the workflow. The first workflow input, `fastqgz_file_read_1`, should be the read file. This could be the only file containing sequencing reads in your data, or the first of two read files if the sample has paired-end reads.

In this example, the column of the DATA which points to the first read of the fastq file is called "read1". It will look like "this.read1" when selecting this column.
